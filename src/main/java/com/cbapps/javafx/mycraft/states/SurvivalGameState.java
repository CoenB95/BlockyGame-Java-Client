...
public class SurvivalGameState extends LookGameState {
	...
	public SurvivalGameState(World world, GameObject steve) {
		super(world, steve);
	...
	public void onResume() {
		...
		camera.addComponent(new SmoothTranslationComponent(0.05));
	}
	...
	public void onKeyPressed(KeyEvent event) {
		...
		if (event.getCode() == KeyCode.ESCAPE) {
			...
			var newGameMode = new SpectatorGameState(world, steve);
			getScene().popState();
